...
<body>
   ...
   <form id="login" action="/loginSuccess" method="post">
    <h1 id="ff-proof" class="ribbon">CoZy 관리자 로그인 &nbsp;&nbsp;</h1>
    
    <fieldset id="inputs">
        <input id="username" type="text" name="uid" id="uid" autofocus placeholder="아이디" />
        <input id="password" type="password" name="upwd" id="upwd" placeholder="비밀번호" />
    </fieldset>
    <fieldset id="actions">
