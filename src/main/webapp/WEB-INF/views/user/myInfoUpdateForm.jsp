...
<section id="fancyTabWidget" class="tabs t-tabs">
   ...
   <label>연락처</label>
   <span class="input_area"id = "tt"><input type="text" class="form-control" name="uphone" id="uphone" value="${e.uphone}" maxlength="11" placeholder="(-없이)01012345678" required="required" onkeyup="uphonecheck();"/></span><span id="uphoneChk" class="chk"></span><br>
   ...
   <div class="btnArea">
               <button style="width:300px; height:50px; font-size :20pt;" type="button" class="btn btn-default" id="joinBtn" onclick="updatechk()">수정하기</button>
    </div>
    </form:form></div>
    <script>
